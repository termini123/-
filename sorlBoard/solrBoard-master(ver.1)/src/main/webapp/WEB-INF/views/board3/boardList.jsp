...
<body>                 
    ...
    <form id="form1" name="form1"  method="post">
        ...
        <div>
            <input type="checkbox" name="searchType" value="invention_title" <c:if test="${fn:indexOf(searchVO.searchType, 'invention_title')!=-1}">checked="checked"</c:if>/>
            <label class="chkselect" for="searchType1">제목</label>
            <input type="checkbox" name="searchType" value="KR_OpenNumber" <c:if test="${fn:indexOf(searchVO.searchType, 'KR_OpenNumber')!=-1}">checked="checked"</c:if>/>
